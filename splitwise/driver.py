...
user1 = userController.addUser('user1', 's1')
user2 = userController.addUser('user2', 's2')
user3 = userController.addUser('user3', 's3')
user4 = userController.addUser('user4', 's4')
user5 = userController.addUser('user5', 's5')
